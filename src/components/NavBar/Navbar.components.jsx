...
const NavBar = () => (
    <div className="navbar">
        <a href="google.com" className="navbar__logo">
        ...
        <ul className="navbar__list">
            <li className="navbar__list--item">
                <a href="www.login.com" className="navbar__list--link">Log in</a>    
            </li>
            <li className="navbar__list--item">
                <a href="www.login.com" className="navbar__list--link">Sign Up</a>
            </li>
